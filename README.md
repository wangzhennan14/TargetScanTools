...
Agarwal V, Subtelny AO, Thiru P, Ulitsky I, Bartel DP. Widespread conservation and function of microRNA targets 
sites in Drosophila. _**eLife (Submitted)**_. (2017).

I release my code to enhance reproducibility and as a suite of complementary tools to [TargetScan](www.targetscan.org) 
...
For a professional codebase to compute context scores for flies or other insects more accurately while incorporating 
3' UTR isoform information, I recommend downloading the code provided in [TargetScan](http://www.targetscan.org/cgi-bin/targetscan/data_download.cgi?db=fly_12) 
...
In order to better understand the methodological details for the evolutionary analyses, I recommend the following resources, which
...
I would recommend reading the code closely and modifying commented pieces as appropriate to acquire 
...
files are missing that make the code unusable, or if you identify a major problem in the code, please 
raise a Github issue and I'll try my best to help.
...
This script should be able to run on the precomputed data provided in the folder and generate the figures.
