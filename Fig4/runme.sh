...
#./find_targetsites.pl
#./collect_features.pl >context_8mer7m87A1_knockouts.out

#export MIRSEQFILE=./microRNAs_transfections.txt
#./find_targetsites.pl
#./collect_features.pl >context_8mer7m87A1_transfections.out
...
#./find_targetsites.pl
#./collect_features.pl >context_8mer7m87A1_knockouts_shortestUTR.out

#export MIRSEQFILE=./microRNAs_transfections.txt
#./find_targetsites.pl
#./collect_features.pl >context_8mer7m87A1_transfections_shortestUTR.out
